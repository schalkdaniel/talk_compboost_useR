...
## 
## 
## Train 5000 iterations in 186 Seconds.
...
\hlstd{cboost}\hlopt{$}\hlkwd{addLogger}\hlstd{(}\hlkwc{logger} \hlstd{= LoggerTime,} \hlkwc{use_as_stopper} \hlstd{=} \hlnum{TRUE}\hlstd{,} \hlkwc{logger_id} \hlstd{=} \hlstr{"time"}\hlstd{,}
  \hlkwc{max_time} \hlstd{=} \hlnum{2L}\hlstd{,} \hlkwc{time_unit} \hlstd{=} \hlstr{"seconds"}\hlstd{)}
...
##   500/10000   risk = 7.9  oob_risk = 8.2   time = 0   
##  1000/10000   risk = 6.3  oob_risk = 6.6   time = 0   
##  1500/10000   risk = 5.1  oob_risk = 5.4   time = 0   
##  2000/10000   risk = 4.2  oob_risk = 4.5   time = 1   
##  2500/10000   risk = 3.5  oob_risk = 3.8   time = 1   
##  3000/10000   risk = 3.2  oob_risk = 3.5   time = 1   
## 
## 
## Train 3157 iterations in 2 Seconds.
## Final risk based on the train set: 3
\end{verbatim}
\end{kframe}
\end{knitrout}
